...
} from '/var/task/Desktop/DELV LANDING PAGE/delv-landing/.netlify/dist/run/handlers/request-context.cjs'
import { getTracer } from '/var/task/Desktop/DELV LANDING PAGE/delv-landing/.netlify/dist/run/handlers/tracer.cjs'

process.chdir('/var/task/Desktop/DELV LANDING PAGE/delv-landing')
  ...
  const handlerResponse = await runWithRequestContext(requestContext, () => {
    return tracer.withActiveSpan('Next.js Server Handler', async (span) => {
      span.setAttributes({
        ...
        monorepo: true,
        cwd: '/var/task/Desktop/DELV LANDING PAGE/delv-landing',
      })
      if (!cachedHandler) {
        const { default: handler } = await import('/var/task/Desktop/DELV LANDING PAGE/delv-landing/.netlify/dist/run/handlers/server.js')
