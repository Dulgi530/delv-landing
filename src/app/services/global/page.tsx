...
const content = {
  ko: {
    badge: "서비스 05",
    title: "자회사 설립·해외진출",
    accentLine: "스위스, 싱가포르, 한국\n글로벌 거점을 함께 만듭니다",
    desc: "주요 국가의 재단·법인 설립을 지원합니다. Korean Market Entry 서비스로 해외 기업의 한국 진출도 원스톱으로 도와드립니다.",
    cta: "상담 문의하기",
    locTitle: "주요 진출 거점",
    locations: [
      { flag: "🇨🇭", country: "스위스", city: "Zug / Lugano", tag: "Crypto Valley", desc: "전 세계 최대 블록체인 허브. 현지 주재원을 통한 네트워크 연결·투자자 미팅·법인 설립까지 원스톱 지원." },
      { flag: "🇸🇬", country: "싱가포르", city: "Singapore", tag: "Asia Hub", desc: "아시아 Web3 허브. 규제 친화적 환경에서의 법인·재단 설립 및 현지 파트너십 구축 지원." },
      { flag: "🇰🇷", country: "한국", city: "Seoul", tag: "Korean Market Entry", desc: "해외 프로젝트의 한국 시장 진출 전담 지원. 현지화 전략, 규제 대응, 커뮤니티 빌딩까지." },
      { flag: "🌐", country: "기타", city: "Global", tag: "Custom", desc: "케이맨, UAE, 홍콩 등 프로젝트 특성에 맞는 최적의 거점 선정 및 설립 지원." },
    ],
    servicesTitle: "주요 서비스",
    services: [
      { title: "해외 재단·법인 설립", desc: "스위스·싱가포르·케이맨 등 주요 거점에서 재단 및 법인 설립 전 과정 지원." },
      { title: "스위스 Crypto Valley 진출", desc: "현지 주재원을 통한 글로벌 네트워크 연결, 투자자 미팅, 법인 설립까지 원스톱 지원." },
      { title: "Korean Market Entry", desc: "해외 Web3 프로젝트의 한국 시장 진출 전담 지원. 현지화 전략, 규제 대응, 파트너십 구축 포함." },
      { title: "국내 법인·재단 설립", desc: "국내 법인·재단 설립 절차 지원. 블록체인 특화 법인 구조 설계 및 규제 준수 전략 포함." },
      { title: "현지화 전략 수립", desc: "각 국가의 문화·규제·시장 특성에 맞는 현지화 전략 수립." },
      { title: "글로벌 파트너십 구축", desc: "현지 거래소, VC, 미디어, 커뮤니티와의 파트너십 구축." },
    ],
    ctaTitle: "해외 진출을 준비하고 계신가요?",
    ctaDesc: "델브의 글로벌 네트워크로 빠르고 안전하게 진출하세요.",
  },
  en: {
    badge: "Service 05",
    title: "Subsidiary & Global Expansion",
    accentLine: "Switzerland, Singapore, Korea\nBuilding global bases together",
    desc: "We support foundation and entity establishment in major countries. Our Korean Market Entry service also helps overseas companies enter the Korean market end-to-end.",
    cta: "Contact Us",
    locTitle: "Key Expansion Locations",
    locations: [
      { flag: "🇨🇭", country: "Switzerland", city: "Zug / Lugano", tag: "Crypto Valley", desc: "World's largest blockchain hub. One-stop support from network connections to investor meetings and entity establishment." },
      { flag: "🇸🇬", country: "Singapore", city: "Singapore", tag: "Asia Hub", desc: "Asia's Web3 hub. Support for entity and foundation establishment in a regulation-friendly environment." },
      { flag: "🇰🇷", country: "Korea", city: "Seoul", tag: "Korean Market Entry", desc: "Dedicated support for overseas projects entering the Korean market. Localization strategy, regulatory compliance, and community building." },
      { flag: "🌐", country: "Others", city: "Global", tag: "Custom", desc: "Support for selecting and establishing the optimal base in Cayman, UAE, Hong Kong, etc." },
    ],
    servicesTitle: "Core Services",
    services: [
      { title: "Overseas Foundation & Entity Setup", desc: "Full process support for foundation and entity establishment in Switzerland, Singapore, Cayman, etc." },
      { title: "Swiss Crypto Valley Entry", desc: "One-stop support through our local representative: global network connections, investor meetings, and entity establishment." },
      { title: "Korean Market Entry", desc: "Dedicated support for overseas Web3 projects entering Korea. Includes localization strategy and partnership building." },
      { title: "Domestic Entity & Foundation Setup", desc: "Support for domestic entity and foundation establishment with blockchain-specialized structure design." },
      { title: "Localization Strategy", desc: "Establish localization strategies tailored to each country's culture, regulations, and market characteristics." },
      { title: "Global Partnership Building", desc: "Build partnerships with local exchanges, VCs, media, and communities using DELV's global network." },
    ],
    ctaTitle: "Preparing for Global Expansion?",
    ctaDesc: "Enter markets quickly and safely with DELV's global network.",
  },
};
