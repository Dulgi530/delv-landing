...
const content = {
  ko: {
    badge: "서비스 04",
    title: "RWA 도입 자문",
    accentLine: "갤러리·부동산·현물을 토큰화하여\n새로운 자금조달 채널을 엽니다",
    rwaBadge: "RWA란?",
    rwaDesc: "Real World Asset(RWA)은 갤러리·부동산·현물 등 실물 자산을 블록체인 토큰으로 표현하는 기술입니다. 소유권 분할과 글로벌 유통이 가능해지며, 기존에 자금조달이 어려웠던 자산도 RWA를 통해 새로운 투자자 접근과 유동성 확보가 가능합니다.",
    cta: "상담 문의하기",
    assetsTitle: "토큰화 가능한 자산",
    assets: [
      { icon: "🏢", title: "부동산", desc: "상업용·주거용 부동산을 토큰화하여 소액 투자자를 유치하고 새로운 자금조달 채널을 확보합니다." },
      { icon: "🎨", title: "갤러리·예술품", desc: "미술품·수집품의 소유권을 분할하여 글로벌 투자자 유치 및 자금조달이 가능합니다." },
      { icon: "🪙", title: "현물 자산", desc: "금·원자재 등 현물을 온체인으로 표현하여 실시간 거래와 담보 활용으로 자금을 조달합니다." },
      { icon: "📄", title: "채권·금융 상품", desc: "사채·채권 토큰화로 기존 금융 채널 외 새로운 글로벌 자금조달 경로를 확보합니다." },
      { icon: "🏭", title: "인프라·설비", desc: "제조·에너지 설비 토큰화로 투자자와 수익을 공유하고 설비 확충 자금을 조달합니다." },
      { icon: "💡", title: "지식재산권", desc: "특허·저작권 토큰화로 라이선스 수익을 분배하고 IP 기반 자금조달을 실현합니다." },
    ],
  ...
  en: {
    badge: "Service 04",
    title: "RWA Advisory",
    accentLine: "Tokenize galleries, real estate & commodities\nto open new fundraising channels",
    rwaBadge: "What is RWA?",
    rwaDesc: "Real World Asset (RWA) is a technology that represents real-world assets — such as galleries, real estate, and commodities — as blockchain tokens. Ownership can be fractionalized and distributed globally, enabling new investor access and liquidity for assets that were previously difficult to fund.",
    cta: "Contact Us",
    assetsTitle: "Tokenizable Asset Types",
    assets: [
      { icon: "🏢", title: "Real Estate", desc: "Tokenize commercial/residential property to attract small investors and secure new fundraising channels." },
      { icon: "🎨", title: "Art & Galleries", desc: "Fractionalize ownership of artworks and collectibles to attract global investors and raise capital." },
      { icon: "🪙", title: "Physical Assets", desc: "Represent gold and commodities on-chain for real-time trading and collateral-based fundraising." },
      { icon: "📄", title: "Bonds & Financial Instruments", desc: "Secure new global fundraising channels beyond traditional finance through bond tokenization." },
      { icon: "🏭", title: "Infrastructure & Equipment", desc: "Share revenue with investors through equipment tokenization to fund facility expansion." },
      { icon: "💡", title: "Intellectual Property", desc: "Realize IP-based fundraising by distributing licensing revenue through patent and copyright tokenization." },
    ],
