...
import { web3Data } from "@/app/chat-data/web3-data";
import { searchKeywords } from "@/app/chat-data/web3-data";
...
export default function Home() {
  ...
  const renderHomePage = () => (
    <div className="min-h-screen bg-[#1A202C] flex flex-col relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              ...
              {/* Language Selector - DELV CHAT 자체 언어 선택 유지 */}
              <LanguageSelector />
            </div>
          </div>
        </div>
      ...
      <div className="bg-gray-900/50 backdrop-blur-sm border-t border-purple-500/20 relative z-10">
        <div className="container mx-auto px-4 py-12">
          <h2 className="text-3xl font-bold text-white text-center mb-8 animate-slide-up">
            {t.howToUse}
          </h2>
  ...
  const renderMainPage = () => (
    <div className="min-h-screen bg-[#1A202C] flex flex-col">
      ...
      <div className="flex-1 flex flex-col lg:flex-row pt-20">
        {/* 사이드바 */}
        <div className="w-full lg:w-80 bg-gray-900/50 backdrop-blur-sm border-b lg:border-r lg:border-b-0 border-purple-500/20 p-4 lg:p-6 pt-6">
          {/* 검색 */}
              ...
              <Button
                ...
                onClick={() => {
                  ...
                  const randomIndex = Math.floor(
                    Math.random() * searchKeywords.ko.length
                  );
        ...
        {/* 메인 콘텐츠 영역 */}
        <div className="flex-1 p-4 lg:p-8 pt-20">
          {searchResults.length > 0 ? (
            ...
            <div>
              <h2 className="text-3xl font-bold text-white mb-6">
                {web3Data[selectedCategory].category}
              </h2>
              {selectedItem ? (
                <div className="space-y-6">
                  ...
                  <div className="bg-gray-800/50 border border-gray-700 p-8 rounded-lg">
                    <TranslatableContent
                      originalText={selectedItem.question}
                      className="mb-6"
                    >
                    ...
                    {selectedItem.tips && (
                      <div className="mt-8 bg-blue-500/10 border border-blue-500/20 p-6 rounded-lg">
                        ...
                        <TranslatableContent
                          originalText={selectedItem.tips}
                          showTranslateButton={false}
                        >
                ...
                <div className="space-y-4">
                  {web3Data[selectedCategory].items.map((item, itemIndex) => (
                    <div
                      ...
                      className="p-6 bg-gray-800/50 border border-gray-700 rounded-lg cursor-pointer hover:bg-gray-700/50 transition-colors"
                      onClick={() =>
                        handleItemSelect(selectedCategory, itemIndex)
                      }
                    >
                      <div className="flex items-center justify-between mb-2">
                        <TranslatableContent
            ...
            <div className="flex flex-col items-center justify-center h-full text-center">
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-2xl">
                왼쪽 메뉴에서 궁금한 카테고리를 선택하거나 질문을 검색하여
                Web3에 대한 모든 것을 알아보세요. DELV CHAT이 여러분의 Web3
                여정을 도와드립니다.
              </p>
              <div className="text-lg text-purple-300 italic mb-4">
                💡 복잡한 Web3, 이제 쉽게 배우세요!
              </div>
              <div className="text-sm text-gray-400">
                💬 AI 채팅으로 더 자세한 질문도 가능합니다
              </div>
            </div>
          )}
        </div>
