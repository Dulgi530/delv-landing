...
const koTranslations: TranslationData = {
  ...
  welcomeDescription:
    "복잡한 블록체인 세상이 막막하신가요? 걱정 마세요! 왼쪽 메뉴에서 궁금한 주제를 골라보거나, 검색창에 질문을 던져보세요. DELV CHAT이 쉽고 재미있게 설명해드릴게요! 🚀",
  ...
  // AI 채팅
  aiAssistant: "DELV CHAT AI 어시스턴트",
  ...
  buyTokens: "토큰 구매하기",
  startConversation: "DELV CHAT과 대화를 시작하세요!",
  startConversationDesc:
    "Web3, 블록체인, DeFi, NFT 등에 대해 무엇이든 물어보세요.",
...
const offlineTranslations: Record<Language, TranslationData> = {
  ...
  en: {
    ...
    welcomeDescription:
      "Feeling overwhelmed by the complex blockchain world? Don't worry! Choose a topic from the left menu or ask questions in the search bar. DELV CHAT will explain everything easily and fun! 🚀",
    slogan: "Complex Web3, now easy to learn through conversation! 💬✨",
    tip: "💡 Tip: Real-time questions available via AI chat!",
    searchResults: "Search Results",
    noResults: "No results found.",
    aiAssistant: "DELV CHAT AI Assistant",
    ...
    startConversation: "Start conversation with DELV CHAT!",
    startConversationDesc:
      "Ask anything about Web3, blockchain, DeFi, NFT, etc.",
    ...
    conversationalLearningDesc:
      "Easily understand Web3 concepts through AI conversation",
    ...
    step3Desc:
      "Click on questions you're curious about for detailed explanations",
  ...
  ja: {
    ...
    welcomeDescription:
      "複雑なブロックチェーンの世界に圧倒されていませんか？心配しないでください！左のメニューからトピックを選ぶか、検索バーで質問してください。DELV CHATが簡単で楽しく説明します！🚀",
    slogan: "複雑なWeb3、今は会話で簡単に学べます！💬✨",
    tip: "💡 ヒント：AIチャットでリアルタイム質問も可能です！",
    searchResults: "検索結果",
    noResults: "結果が見つかりません。",
    aiAssistant: "DELV CHAT AIアシスタント",
    ...
    buyTokens: "トークンを購入",
    startConversation: "DELV CHATとの会話を始めましょう！",
    startConversationDesc:
      "Web3、ブロックチェーン、DeFi、NFTなど何でも聞いてください。",
    generating: "回答を生成中...",
    aiCanMakeErrors:
  ...
  zh: {
    ...
    welcome: "欢迎来到Web3世界！🎉",
    welcomeDescription:
      "被复杂的区块链世界搞得不知所措？别担心！从左侧菜单选择主题或在搜索栏提问。DELV CHAT将轻松有趣地为您解释一切！🚀",
    slogan: "复杂的Web3，现在通过对话轻松学习！💬✨",
    tip: "💡 提示：通过AI聊天可进行实时提问！",
    searchResults: "搜索结果",
    noResults: "未找到结果。",
    aiAssistant: "DELV CHAT AI助手",
    ...
    buyTokens: "购买代币",
    startConversation: "开始与DELV CHAT对话！",
  ...
  es: {
    ...
    welcomeDescription:
      "¿Te sientes abrumado por el complejo mundo blockchain? ¡No te preocupes! Elige un tema del menú izquierdo o haz preguntas en la barra de búsqueda. ¡DELV CHAT te explicará todo de manera fácil y divertida! 🚀",
    slogan:
      "Web3 complejo, ¡ahora fácil de aprender a través de la conversación! 💬✨",
    tip: "💡 Consejo: ¡Preguntas en tiempo real disponibles a través del chat IA!",
    searchResults: "Resultados de Búsqueda",
    noResults: "No se encontraron resultados.",
    aiAssistant: "Asistente de IA DELV CHAT",
    ...
    startConversation: "¡Comienza la conversación con DELV CHAT!",
    startConversationDesc:
      "Pregunta cualquier cosa sobre Web3, blockchain, DeFi, NFT, etc.",
    ...
    conversationalLearningDesc:
      "Comprende fácilmente los conceptos de Web3 a través de la conversación con IA",
    ...
    reliableInfoDesc:
      "Respuestas basadas en conocimientos especializados verificados de Web3",
    howToUse: "Cómo usar",
    step1Title: "Haz clic en Explorar Web3",
    step1Desc:
      "Navega a la pantalla principal para explorar varios temas de Web3",
    step2Title: "Selecciona Categoría",
    step2Desc: "Elige una categoría de interés o busca temas",
    step3Title: "Selecciona Pregunta",
    step3Desc:
      "Haz clic en las preguntas que te interesen para obtener explicaciones detalladas",
    step4Title: "Usa el Chat de IA",
    step4Desc:
      "Si tienes preguntas adicionales, obtén más información a través del chat de IA",
  },
  fr: {
    title: "DELV CHAT 101",
    ...
    welcomeDescription:
      "Vous vous sentez dépassé par le monde complexe de la blockchain ? Ne vous inquiétez pas ! Choisissez un sujet dans le menu de gauche ou posez des questions dans la barre de recherche. DELV CHAT vous expliquera tout de manière simple et amusante ! 🚀",
    slogan:
      "Web3 complexe, maintenant facile à apprendre par la conversation ! 💬✨",
    tip: "💡 Astuce : Questions en temps réel disponibles via le chat IA !",
    searchResults: "Résultats de Recherche",
    noResults: "Aucun résultat trouvé.",
    aiAssistant: "Assistant IA DELV CHAT",
    remainingQueries: " restantes",
    premium: "Premium",
    ...
    startConversation: "Commencez la conversation avec DELV CHAT !",
    startConversationDesc:
      "Demandez n'importe quoi sur Web3, blockchain, DeFi, NFT, etc.",
    ...
    conversationalLearningDesc:
      "Comprenez facilement les concepts de Web3 grâce à la conversation avec l'IA",
    fastAnswers: "Réponses Rapides",
    fastAnswersDesc:
      "Résumés concis des concepts complexes en quelques secondes",
    ...
    step3Desc:
      "Cliquez sur les questions qui vous intéressent pour obtenir des explications détaillées",
    step4Title: "Utilisez le Chat IA",
    step4Desc:
      "Pour des questions supplémentaires, apprenez-en davantage grâce au chat IA",
  },
};
